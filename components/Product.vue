...
<!--              </div>-->
            ...
            <p class="mb-39">{{ post.description }}</p>
<!--            <h2 class="title">{{ post.capabilities }}</h2>-->
            ...
            <div class="thumb">
              <!--                <img src="/images/portfolio/tab-b1.jpg" alt="image">-->
              <img :src="`http://localhost:1337${post.descrImg.url}`" :alt="post.title">
...
<!--            </div>-->
<!--            &lt;!&ndash;                JOB APPLY / send CV form component&ndash;&gt;-->
<!--            <applyJob />-->
<!--          </div>-->
<!--        </div>-->
